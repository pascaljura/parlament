...
if (isset($_GET['id_zapis']) && filter_var($_GET['id_zapis'], FILTER_VALIDATE_INT)) {
    ...
    if ($result->num_rows > 0) {
        ...
        $zapis = preg_replace('/\/\/([^\/]+)\/\//', '<div style="color: #3e6181; font-weight: bold; font-size: 18pt;">$1</div>', $zapis);
...
<div style="text-align: center;">
    <img src="https://www.alba-rosa.cz/parlament/favicon.ico" width="180px" height="200px" alt="Logo">
    <table style="width: 100%; font-size: 9pt; border-top: 2px solid black; border-collapse: collapse;">
        <tr>
            <td>Číslo dokumentu: ' . $cislo_dokumentu . '/' . $datum . '</td>
            <td>Počet stran: 1</td>
            <td>Počet příloh: 0</td>
        </tr>
        <tr>
            <td>Dokument</td>
            <td></td>
...
// Body HTML
$bodyHtml = '
<div style="font-size: 22pt; font-weight: bold; margin-top: 10px;">
