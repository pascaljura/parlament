...
-- Vytvořeno: Čtv 19. zář 2024, 18:43
...
INSERT INTO `other` (`id`, `text`, `aktivni`) VALUES
...
(2, '        <div class="table-heading">\n  <b>&#x1F499;・Aktuálně・2023/2024</b>\n       </div>\n<div id="poster">\n            <a href="./assets/img/plakat.png" target="_blank">\n                <img src="./assets/img/plakat.png" id="responsive-image"\n                    style="margin: 5px; width: 30%; height: 80%;  border-radius: 3%;@media (max-width: 767px, 560px) { width: 100%; height: auto; }">\n            </a>\n        </div>', 0),
...
(61, '2024-06-11', '**Parlament výlet**=- **Den 1**=- 6:00 sraz Brno hl.n (vestibul)=- Brno **Pálava**=-- Děvičky=- Pálava=> **Lednice**=-- Burger=-- Prohlídka zámku a okolí=-- Minaret=- Lednice => **Pasohlávky**=-- Ubytování=- **Den 2**=- Volná zábava=- Pasohlávky => **Brno**=**Letní program**=- Klub kávy a přátel bude promítat i filmy=- Upoutávky=**Program na Čichnově**=- Den lidských práv=-- Workshopy, přednášky=- Bližší informace později=**Memorandum s parlamentem na Střední škole informatiky, poštovnictví a finančnictví Čichnova**=- Je v pořádku=- Podpis'),
(62, '2024-09-19', '**Čas schůze**=- úterý 8.h / pátek 7.h=**Jak to bude s volbou předsedy**=**O náboru prvních ročníků do školního Parlamentu**=**Dořešení nabíječek**');
