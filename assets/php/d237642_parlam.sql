...
-- Vytvořeno: Stř 02. říj 2024, 19:57
...
(2, 'fanda', 'František Vaněk', 'parlamentNaPurkynce'),
...
(8, 1, '2023-12-19', '**Řešení vánočního dne**=- Místnosti=- Dozory=- Hlášení tříd a jednotlivců u MAPA=**Tři králové**=- 1. skupina: Kačmařík. Buchtová, Němec=- 2. skupina: Brandejs, Pokorná, Abbod=- Náhradníci: Kropáček'),
...
(12, 1, '2023-10-31', '**Adaptační program parlamentu**=- Zhodnocení=**Poznámky na ředitele, schůze 01. 11. 2023**=- Chování zaměstnanců=- Kvalitnější káva=- Pozvat hejtmana (Richard)=- Automatické propustky při zrušené výuce=- Funkčnost rozhlasů=- Zrcadlo na chodbě=- Aktualizace sifonu=**Web parlamentu**=- Zápisy ze schůzí=**Nové volby na vedení parlamentu**=- Místopředseda: Martin =- Místo místopředseda: Eli'),
...
(43, 1, '2024-01-23', '**Valentýn**=- Kde budou schránky, jak budou upevněny?=- Jak to bude probíhat a co je potřeba nachystat?=**Mikiny**=- Velikost a pozice loga'),
...
(45, 1, '2024-02-13', '**Podměty pro ředitele**=- Stěny mezi pisoáry=- Funkční zámky na záchody=- Testy online mimo počítačové učebny=- Mikrovlnky před obědem =- Stránky na telefonu (jejich obsah je jiný než na PC)=- Debatní kroužek =- Posezení na chodbách ve 4. patře=- Automat na kávu ve 2. patře=**Mikiny a trička**=- Značení loga=**Valentýn**=- Vyhodnocení akce a příprava na rozdávání'),
...
(47, 1, '2024-02-27', '**Velikonoce**=- Stále v řešení místa na QR kódy=- Ceny za první tři výherní místa=- Plakát'),
...
(49, 1, '2024-03-26', '**Velikonoce**=- Roznesení QR kódů=- Rozhlášení rozhlasem a EduPage=-- Kdo bude hlásit=- Stránka hotová=-- Vzhled dortu=- Vyhlášení výherců=-- Výhry=-- Kdo a kde bude předávat ceny=**Krajský Studentský sněm**=- Řád parlamentu=**Výlet pro parlament**=- Informace z loňského roku=- Kdo, kam, kdy a na jak dlouho by se jelo=- 2. učitel=**Parlament merch**=- Kolik lidí a kdo chce=- Cena'),
(51, 1, '2024-04-02', '**Velikonoce**=- Zprávy výhercům=-- Rozhlas=- Předání výher =-- Sborovna 9:40 3.4. (musí být přítomen učitel)=- Nekompatibilita ios=**Setkání s ředitelem**=- Podněty od žáků=- Uzavírání známek pro čtvrťáky: důvod=**Mikiny** =- Uzavření výběru=**No backpack day**=- Omezení na velikost aktovky, 9.5.=**Výlet za odměnu**=- 1 nebo 2 dny=- Bítov=- kolem 21.6.=**Moderátor na 8.4.**'),
(52, 1, '2023-11-07', '**Zhodnocení akce Halloween**=- Bonbóny uspěly=- Účast větší než minulý rok=**Nové výbory parlamentu**=- Nový výbor IT=- Spojka mezi námi a panem Čížkem=- Adam Abbod=- Nový výbor komunikace (vyjednávání)=- Spojka mezi učiteli a námi=- Bohuslav a Jakub=**Stanovení plánu akcí**=- Bude k dispozici na teams=- Řeší výbor plánování akcí=- Do 14.11.=**Pozvání pana hejtmana **=- Beseda 50-100 lidí=- V řešení omezený počet míst =- Formou přihlášení=**Zrcadlo**=- Musí se najít místo=**Časy na počítačích**=- Řeší výbor IT=**Den otevřených dveří**		=- Zájemci na dobrovolníky =- Řeší Martin s paní Klobásovou=**Purples**=- Zájemci na dobrovolníky=- Řeší Eli s Purplesem=**Rozhlas**=- Jen důležité akce (odhlasováno)=- Řeší Sarah=**Stále v řešení:**=- Mikuláš =- Promyslet, kdo by chtěl jít=- Logo Parlamentu=- Bude nápis Purkyňova (odhlasováno)=- Slevy v kantýně'),
...
(62, 1, '2024-09-19', '**Čas schůze**=- úterý 8.h / pátek 7.h=**Jak to bude s volbou předsedy**=**O náboru prvních ročníků do školního Parlamentu**=**Dořešení nabíječek**'),
...
--
ALTER TABLE `zapis`
  MODIFY `id_zapis` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=65;
