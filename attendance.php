...
<body>
    <div id="calendar">
        ...
        <body>
            ...
            <p><a href="' . $verifyLink . '"><button style="color: #fff; background-color: #007acc; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer;">' . $verifyLink . 'Potvrdit účast!</button></a></p>
